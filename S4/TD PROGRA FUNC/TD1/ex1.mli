...
fun x -> 2. *. x +. 1.;;                                    (* <fun> float = float *)    
let f = fun x -> 2. *. x +. 1.;;                            (* val f : <fun> float = 2. *. x +. 1. *)    
(f 2);;                                                     (* error int != float *)
(f 2.5);;                                                   (* -:float 6. = *)   
(f 0.5) +. (f 1.0);;                                        (* -:float 5. = *)    
f(f 2.0);;                                                  (* -:float 11. = *)   
...
let 0point = (0., 0.);;                                     (* val 0point : (float, float) = (0., 0.) *)    
let Origin = (0., 0.);;                                     (* val Origin : (float, float) = (0., 0.) *)    
...
lastname ^ ", " ^ firstname ^ ": " ^                           
if is_student then "étudiant" else "enseignant";;           (* val to_string : <fun> (string, string, bool) -> string *)   
to_string _person;;                                         (* val to_string : string "Anne, Nonyme: étudiant" *)   
