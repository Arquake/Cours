...
public class User extends AbstractUser {
    ...
    public void creerUnSondage(String libelle, List<String> responses) {
        try {
            RMI.createPoll(this, libelle, responses);
    ...
    public void getSondages(){
        try {
            System.out.println(RMI.listPolls());
        }
        catch (RemoteException e) {
            System.err.println(e.getMessage());
        }
    ...
    public void getOneSondage(String uuid) {
        try {
            System.out.println(RMI.getPoll(uuid));
    ...
    public void getSondageParticipations() {
        try {
            System.out.println(RMI.getPollCollaboratedIn(this.uuid));
        } catch (RemoteException e) {
            System.err.println(e.getMessage());
        } catch (UserDontExistException e) {
            System.err.println(e.getMessage());
    ...
    public void answerSondage() {
        ...
        try {
            ...
            RMI.answerPoll(this.uuid, input, Integer.parseInt(choice));
    ...
    public void getUserInfo() {
        try {
            System.out.println(RMI.getProfileInfo(this.uuid));
        } catch (RemoteException e) {
            System.err.println(e.getMessage());
        } catch (UserDontExistException e) {
            System.err.println(e.getMessage());
